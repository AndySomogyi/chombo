...
//   a_ambientDensity - Ambient density add to the density sinusoid
//   a_deltaDensity   - Mean of the sinusoid
//   a_pressure       - If 0, use isentropic pressure
//                      if 1, use the constant pressure of 1.0
//   a_center         - Center of the peak of the sinusoid
                               ...
                               const Real&     a_artvisc)
{
  ...
  FORT_SINESETF(CHF_REAL(a_smallPressure),
...
PhysIBC* SineIBC::new_physIBC()
{
  SineIBC* retval = new SineIBC();
...
void SineIBC::initialize(LevelData<FArrayBox>& a_U)
{
