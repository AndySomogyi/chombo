...
GaussianIBC::GaussianIBC(Real&           a_smallPressure,
                         const Real&     a_gamma,
...
void GaussianIBC::setFortranCommon(Real&           a_smallPressure,
                                   const Real&     a_gamma,
                                   const Real&     a_ambientDensity,
                                   const Real&     a_deltaDensity,
                                   const int&      a_pressure,
                                   ...
                                   const Real&     a_artvisc)
{
  ...
  FORT_GAUSSIANSETF(CHF_REAL(a_smallPressure),
...
PhysIBC* GaussianIBC::new_physIBC()
{
...
void GaussianIBC::initialize(LevelData<FArrayBox>& a_U)
{
...
// Set boundary fluxes
void GaussianIBC::primBC(FArrayBox&            a_WGdnv,
...
void GaussianIBC::setBdrySlopes(FArrayBox&       a_dW,
                                const FArrayBox& a_W,
                                const int&       a_dir,
                                const Real&      a_time)
{
...
void GaussianIBC::artViscBC(FArrayBox&       a_F,
                            const FArrayBox& a_U,
