...
####
#################################################
###  This is the Ddecl processer.
### Interface is
### sub DdeclProc::procDdeclMacros(inputfile, outputfile,
###                                SpaceDim, debug)
###
###  reads in input file 
#################################################
...
$VERSION = 1.23;
@ISA = qw(Exporter);
@EXPORT = qw(&procDDeclMarcos);
@EXPORT_OK = qw(&procDDeclMacros);
@EXPORT_TAGS= ();

sub DDeclProc::procDDeclMacros
{
