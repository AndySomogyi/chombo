...
####
#################################################
###  This is the Chfix processer.
### Interface is
### sub ChfixProc::procChfixMacros(inputfile, outputfile,
###                                SpaceDim, debug)
###
###  reads in input file 
#################################################
...
$VERSION = 1.23;
@ISA = qw(Exporter);
@EXPORT = qw(&procChfixMarcos);
@EXPORT_OK = qw(&procChfixMacros);
@EXPORT_TAGS= ();

sub ChfixProc::procChfixMacros
{
