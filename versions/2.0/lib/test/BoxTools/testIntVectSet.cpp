...
main(int argc, char* argv[])
{
  ...
  if( ret == 0 )
    {
      cout << indent << pgmname << " passed all tests" << endl ;
    }
  else
    {
      cout << indent << pgmname << " failed one or more tests" << endl ;
    }
...
testIntVectSet()
{
      ...
      if(!(ivs == ivsIn))
        {
          if( verbose )
            {
              cout << indent2 << "TreeIntVectSet linearization failed";
              cout << pgmname << endl ;
            }
          eekflag = true;
      ...
      if (ivs.minBox() != grownBox)
        {
          if( verbose )
            {
              cout << indent2 << "DenseIntVectSet grow test failed minBox test" 
                   << pgmname << endl ;
            }
          eekflag = true;
          fail = true;
          ...
          if(!ivs.contains(bit()))
            {
              if( verbose )
                {
                  cout << indent2 << "fail DenseIntVectSet grow test " 
                       << pgmname << endl ;
                }
              eekflag = true;
              fail = true;
      ...
      if (ivs.minBox() != grownBox)
        {
          if( verbose )
            {
              cout << indent2 << "TreeIntVectSet grow test failed minBox test" 
                   << pgmname << endl ;
            }
          eekflag = true;
          fail = true;
          ...
          if(!ivs.contains(bit()))
            {
              if( verbose )
                {
                  cout << indent2 << "fail TreeIntVectSet grow test " 
                       << pgmname << endl ;
                }
              eekflag = true;
              fail = true;
        ...
        if(it() != it4())
          {
            if( verbose )
              {
                cout << indent2 << "IntVectSet copy/assign problem: ";
                cout << pgmname << endl ;
              }
            eekflag = true;
          }
        ...
        if(!(b3.contains(it()) && b1.contains(it())))
          {
            if( verbose )
              {
                cout << indent2 << "intersection contains extra data: ";
                cout << pgmname << endl ;
              }
            eekflag = true;
          }
        ...
        if(!mask2.contains(bit()))
          {
            if( verbose )
              {
                cout << indent2 << "intersection missed data: ";
                cout << pgmname << endl ;
              }
            eekflag = true;
          }
      ...
      if(!(mask3 == ivsIn))
        {
          if( verbose )
            {
              cout << indent2 << "DenseIntVectSet linearization failed";
              cout << pgmname << endl ;
            }
          eekflag = true;
...

  {
        ...
        if(!(b2.contains(it()) || b1.contains(it()) || b3.contains(it())))
          {
            if( verbose )
              {
                cout << indent2 << "box.coarsen != ivs.coarsen: point falls outside region: ";
                cout << pgmname << endl ;
              }
            eekflag = true;
          }
    ...
    if(count != numpts)
      {
        cout << indent2 << "box.coarsen != ivs.coarsen: count != numpts from union ";
        cout << pgmname << endl ;
        eekflag = true;
      }
  ...
  }
  {
        ...
        if(!(b2.contains(it()) || b1.contains(it()) || b3.contains(it())))
          {
            if( verbose )
              {
                cout << indent2 << "box.coarsen != tivs.coarsen: point falls outside region: ";
                cout << pgmname << endl ;
              }
            eekflag = true;
          }
    ...
    if(count != numpts)
      {
        cout << indent2 << "box.coarsen != tivs.coarsen: count != numpts from union ";
        cout << pgmname << endl ;
        eekflag = true;
      }
    ivs2.clear();
  ...
  {
    Box b1(IntVect(D_DECL(5,5,5)),
           10 * IntVect::Unit);
    Box b2(6 * IntVect::Unit,
           7 * IntVect::Unit);
    Box b3(IntVect(D_DECL(6,8,8)),
           IntVect(D_DECL(7,9,8)));
    Box b4(IntVect(D_DECL(8,6,5)),
           IntVect(D_DECL(9,7,5)));
    Box b5(IntVect(D_DECL(8,8,8)),
           IntVect(D_DECL(9,9,9)));
