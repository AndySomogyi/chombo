                                ...
                                const Box&       a_box)
{
  ...
  int numPrim = m_gdnvPhysics->numPrimitives();
  // Unused after "Uold" was commented out below - TJL 07/27/05
  // int numFlux = m_gdnvPhysics->numFluxes();
  ...
  // Commented out as it is unused at the moment - TJL 07/27/05 (NK's catch)
  ...
  FArrayBox flattening(slopeBox,1);
  ...
  for (int dir1 = 0; dir1 < SpaceDim; dir1++)
  {
    ...
    WHalf1[dir1].resize(fluxBox[dir1],numPrim);
