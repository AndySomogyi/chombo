...
doRegularUpdate(LevelData<EBCellFAB>&         a_divF,
                LevelData<EBCellFAB>&         a_rhsVelo,
                LevelData<EBCellFAB>&         a_rhsTemp,
      ...
      if(!ebisBox.isAllCovered())
        {
          ...
          patchPoly.getRHSTemperature(a_rhsTemp[dit()],
                                      facePrim,
                                      coveredPrimMinu,
                                      coveredPrimPlus,
                                      m_params.m_specHeatCv,
                                      cellBox, ivsIrreg);

          patchPoly.getRHSVelocity(a_rhsVelo[dit()],
                                   facePrim,
                                   coveredPrimMinu,
                                   coveredPrimPlus,
                                   cellBox, ivsIrreg);
         ...
         const Real&                   a_dt)
{
  ...
  doRegularUpdate(a_divergeF, a_rhsVelo, a_rhsTemp, 
                  a_consState, a_fineFluxRegister, a_coarFluxRegister, a_source, a_time, a_dt);
