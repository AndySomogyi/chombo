...
//                    CHF_REALVECT(center));
    ...
    */
    ...
    if (verbose)
      pout() << "*** setting up second AMRNodeSolver *** " << endl;
    ...
    if (verbose)
      pout() << "*** done with second AMRNodeSolver setup *** " << endl;
    amrNodeSolver2.solveAMR(phi2, rhs2);
    if (verbose)
      pout() << "*** done with second solve *** " << endl;
    ...
    */
    ...
    if (verbose)
      pout() << "Did project2 on phi2" << endl;
    if (eekflag != 0)
      {
    ...
    pout() << "NORM OF DIFF (base " << dx20 << " to " << dx0
         << "):  ";
...
#ifdef CH_USE_HDF5
    if (verbose)
      pout() << " writing second amr hierarchy" << endl;
