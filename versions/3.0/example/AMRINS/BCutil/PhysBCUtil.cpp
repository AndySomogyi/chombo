...
public:
  ...
  BasicScalarBCFunction() : m_scalarType(-1) {;}

  BasicScalarBCFunction(int a_scalarType) : m_scalarType(a_scalarType) {;}
...
public:
  ...
  FreestreamCorrBCFunction() : m_isDefined(false) {;}

  FreestreamCorrBCFunction(bool a_isDefined) : m_isDefined(a_isDefined) {;}
...
public:
  ...
  BasicLambdaBCFunction() : m_isDefined(false) {;}

  BasicLambdaBCFunction(bool a_isDefined) : m_isDefined(a_isDefined) {;}
...
public:
  ...
  BasicPressureBCFunction() : m_isDefined(false) {;}
...
public:
  ...
  ExtrapBCFunction() : m_isDefined(false) {;}
...
public:
  ...
  BasicGradPressureBCFunction() : m_isDefined(false) {;}

  BasicGradPressureBCFunction(bool a_isDefined) : m_isDefined(a_isDefined) {;}
...
public:
  ...
  ViscousBCFunction() : m_isDefined(false) {;}

  ViscousBCFunction(bool a_isDefined) : m_isDefined(a_isDefined) {;}
