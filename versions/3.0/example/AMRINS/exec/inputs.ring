main.max_step = 10000  #max number of timesteps to computAe
main.max_step = 10    #max number of timesteps to computAe
...
main.verbosity = 3  #higher number means more verbose
