...
int main(int argc, char* argv[])
{
  ...
  pout() << "Everything done.  mem= " << end_memory
         << "MB wall-clock time: "    << setiosflags(ios::fixed)
         << Everything.wc_time()      << " seconds" << endl;
#endif
...
#ifndef CH_NTIMER
  pout() << "AMR Setup done.  mem= " << get_memory_usage_from_OS()
         << "MB wall-clock time: "
...
#ifndef CH_NTIMER
   pout() << "AMR Conclude completed.  mem= " << get_memory_usage_from_OS()
          << "MB wall-clock time: "
          << setiosflags(ios::fixed)
          << Conclude.wc_time()
          << " seconds" << endl;
