...
EBLevelGrid&
EBLevelGrid::
operator=(const EBLevelGrid&  a_eblg)
{
  if(&a_eblg != this)
    {
      m_isDefined = a_eblg.m_isDefined;
      m_grids    = a_eblg.m_grids;
      m_domain   = a_eblg.m_domain;
      m_ebisPtr  = a_eblg.m_ebisPtr;
      m_ebisl    = a_eblg.m_ebisl;
      m_cfivs    = a_eblg.m_cfivs;
    }
  return *this;
}
