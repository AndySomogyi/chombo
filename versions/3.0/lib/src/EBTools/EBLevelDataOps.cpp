...
{
  //initially set to bogus# so the boundary faces will all be bogus number
  a_faceData.setVal(1.e20);//if you want a better boundary value, have at...
                               ...
                               const bool&                 a_doAbs)
{
  ...
  EBLevelDataOps::parallelMin(a_minVal);
  EBLevelDataOps::parallelMax(a_maxVal);
}
...
Real EBLevelDataOps::sumKappaDotProduct(Real&                a_volume,
                                        ...
                                        const EBCellFAB&     a_data2, const Box& curBox,
                                        int                  a_which,
                                        const ProblemDomain& a_domain)
{
