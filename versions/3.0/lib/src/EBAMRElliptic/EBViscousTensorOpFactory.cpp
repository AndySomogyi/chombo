        ...
        bool                 a_homoOnly)
{
  ...
  int bogRef = 2;
  EBViscousTensorOp* newOp = new EBViscousTensorOp(EBLevelGrid(), eblgMGLevel, EBLevelGrid(), eblgCoarMG,
...
AMRnewOp(const ProblemDomain& a_domainFine)
{
  ...
  EBViscousTensorOp* newOp = new EBViscousTensorOp(eblgFine, eblgMGLevel, eblgCoar, eblgCoarMG,
