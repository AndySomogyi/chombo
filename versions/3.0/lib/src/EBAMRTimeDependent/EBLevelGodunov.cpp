              ...
              if(m_hasFiner)
                {
                  if(m_doRZCoords)
                    {
                      a_fineFluxRegister.incrementCoarseRegulRZ(fluxRegFlux, scale, dit(),
                                                                consInterv, idir, m_dx[idir]);
                    }
                  else
                    {
                      ...
                      if(m_doRZCoords)
                        {
                          ...
                          a_coarFluxRegister.incrementFineRegulRZ(fluxRegFlux,scale, dit(),
                                                                  consInterv, idir,sit(), m_dx[idir]);
                        }
                      else
                        {
              ...
              if(m_hasFiner)
                {
                  if(m_doRZCoords)
                    {
                      a_fineFluxRegister.incrementCoarseIrregulRZ(fluxRegFlux,
                                                                  scale,dit(),
                                                                  consInterv, idir,
                                                                  m_dx[idir]);
                    }
                      ...
                      if(m_doRZCoords)
                        {
                          ...
                          a_coarFluxRegister.incrementFineIrregulRZ(fluxRegFlux,
                                                                    scale, dit(),
                                                                    consInterv, idir,sit(),
                                                                    m_dx[idir]);
                        }
