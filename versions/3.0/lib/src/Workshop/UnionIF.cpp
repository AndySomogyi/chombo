...
IndexTM<Real,GLOBALDIM> UnionIF::normal(const IndexTM<Real,GLOBALDIM>& a_point) const
{
  int closestIF = 0;
  findClosest(a_point,closestIF);
...
Vector< IndexTM<Real,GLOBALDIM> > UnionIF::gradNormal(const IndexTM<Real,GLOBALDIM>& a_point) const
{
  int closestIF = 0;
  findClosest(a_point,closestIF);
...
void UnionIF::findClosest(const IndexTM<Real,GLOBALDIM> & a_point,int & closestIF)const
{
  Real retval = 0.0;
