...
int getError(LevelData<EBCellFAB>& a_errorCoar,
             ...
             const bool& a_doQuaraticInterior);
/***************/
/***************/
...

{
  ...
  {//begin forever present scoping trick
    ...
    const char* in_file = "pwquadinterp.inputs";
    //parse input file
    ...
    int doQuad;
    pp.get("doQuadraticInterior", doQuad);
    bool doQuadraticInterior = (doQuad==1);
    ...
    eekflag = getError(errorFinePart,
                       ...
                       refRatio[0],doQuadraticInterior);
    if(eekflag != 0) return eekflag;
             ...
             const bool& a_doQuadraticInterior)
{
  ...
  EBPWQuadFineInterp interpOp(a_gridsFine, a_gridsCoar,
                              a_ebislFine, a_ebislCoar,
                              a_domainCoar, a_refRatio, nvar,
                              a_doQuadraticInterior);
