                     ...
                     const Vector<int>& a_vecRefRat)
{
  ...
  EBLevelGrid eblgFine(fineGrids, fineEBISL, fineDomain);
  EBLevelGrid eblgMedi(mediGrids, mediEBISL, mediDomain);
  EBLevelGrid eblgCoar(coarGrids, coarEBISL, coarDomain);
  ...
  fineToCoar.define(eblgMedi, eblgCoar, a_vecRefRat[0], nvar, redistRad);
  coarToFine.define(eblgFine, eblgMedi, a_vecRefRat[1], nvar, redistRad);
  coarToCoar.define(eblgFine, eblgMedi, a_vecRefRat[1], nvar, redistRad);
