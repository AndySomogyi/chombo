...
static const char* pgmname = "testBCGEB" ;
...
main(int argc,char **argv)
{
  ...
  // begin forever present scoping trick
  {
    ...
    while(step < steps){
      ...
      const CH_XD::EBIndexSpace* ebisPtr = CH_XD::Chombo_EBIS::instance();
      ...
      for(int i=0; i<3; i++)
        ...
        BiCGStabSolver<LevelData<EBCellFAB> > solver;
        solver.define(opPtr, false);
  ...
  const Real& a_radius)
{
  ...
  CH_XD::EBIndexSpace* ebisPtr = CH_XD::Chombo_EBIS::instance();
